...
public class TestApp {
    public static void main(String[] args) throws Exception {
        System.out.println("=== TEST SIMPLE DE L'APPLICATION ===");
        
        // Créer d'abord des données de test
        creerDonneesTest();
        
        // Puis tester l'affichage
        testAffichageProjet();
    ...
    private static void testAffichageProjet() {
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
        ProjetService projetService = new ProjetService();
        
        // Récupérer le projet créé (ID 1)
